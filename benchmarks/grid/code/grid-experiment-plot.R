...
gr = .5 * (1 + sqrt(5))
setEPS()
cairo_ps("../latex/figures/relative_error_grid.ps", family = "Times", height = 6, width = gr * 4.5, pointsize = 14)
...
setEPS()
cairo_ps("../latex/figures/fscore_grid.ps", family = "Times", height = 6, width = gr * 4.5, pointsize = 14)
