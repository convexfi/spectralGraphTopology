...
gr = .5 * (1 + sqrt(5))
setEPS()
postscript("../latex/figures/relative_error_grid.ps", family = "ComputerModern", height = 6, width = gr * 4.5, pointsize = 14)
...
setEPS()
postscript("../latex/figures/fscore_grid.ps", family = "ComputerModern", height = 6, width = gr * 4.5, pointsize = 14)
plot(n_ratios, fscore_naive, ylim=c(0, 1.), xlab = xlab, ylab = "Average F-score", type = "b",
...
#        col = alpha(colors[4], alpha = .1), border = NA)
axis(side = 1, at = n_ratios, labels = ratios)
legend("bottomright", legend=c(legend1, legend2), col=colors, pch=pch, lty=lty, bty="n")
dev.off()
embed_fonts("../latex/figures/fscore_grid.ps", outfile="../latex/figures/fscore_grid.ps")

#setEPS()
#cairo_ps("../latex/figures/recall_grid.ps", family = "Serif", height = 5, width = gr * 3.7, pointsize = 14 )
...
#dev.off()
#embed_fonts("../latex/figures/recall_grid.ps", outfile="../latex/figures/recall_grid.ps")


#setEPS()
#cairo_ps("../latex/figures/accuracy_grid.ps", family = "Serif", height = 5, width = gr * 3.7, pointsize = 14)
...
#legend("bottomleft", legend=legend, col=colors, pch=pch, lty=lty, bty="n")
#dev.off()
#embed_fonts("../latex/figures/accuracy_grid.ps", outfile="../latex/figures/accuracy_grid.ps")
#
#
#setEPS()
#cairo_ps("../latex/figures/spec_grid.ps", family = "Serif", height = 5, width = gr * 3.7, pointsize = 14)
...
#legend("bottomleft", legend=legend, col=colors, pch=pch, lty=lty, bty="n")
#dev.off()
#embed_fonts("../latex/figures/spec_grid.ps", outfile="../latex/figures/spec_grid.ps")
