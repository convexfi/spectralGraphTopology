...
gr = .5 * (1 + sqrt(5))
setEPS()
postscript("../latex/figures/relative_error_bipartite.ps", family = "ComputerModern", height = 5, width = gr * 3.5, pointsize = 14)
...
setEPS()
postscript("../latex/figures/fscore_bipartite.ps", family = "ComputerModern", height = 5, width = gr * 3.5, pointsize = 14)
