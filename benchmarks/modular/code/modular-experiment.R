...
gr = .5 * (1 + sqrt(5))
setEPS()
postscript("../latex/figures/relative_error_modular.ps", family = "ComputerModern", height = 5, width = gr * 3.5)
...
setEPS()
postscript("../latex/figures/fscore_modular.ps", family = "ComputerModern", height = 5, width = gr * 3.5)
