...
gr = .5 * (1 + sqrt(5))
setEPS()
cairo_ps("../latex/figures/relative_error_modular.ps", family = "Serif", height = 5, width = gr * 3.5)
...
setEPS()
cairo_ps("../latex/figures/fscore_modular.ps", family = "Serif", height = 5, width = gr * 3.5)
