...
library(matrixStats)
library(scales)
ratios <- c(.5, 1.5, 10, 100, 500, 1e3, 1e4)
...
setEPS()
cairo_ps("../latex/figures/recall_grid.ps", family = "Serif", height = 5, width = gr * 3.7)
...
setEPS()
cairo_ps("../latex/figures/accuracy_grid.ps", family = "Serif", height = 5, width = gr * 3.7)
...
setEPS()
cairo_ps("../latex/figures/spec_grid.ps", family = "Serif", height = 5, width = gr * 3.7)
