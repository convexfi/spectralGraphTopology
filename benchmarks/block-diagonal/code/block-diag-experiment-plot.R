...
gr = .5 * (1 + sqrt(5))
setEPS()
cairo_ps("../latex/figures/relative_error_blockdiag.ps", family = "Serif", height = 5, width = gr * 3.7)
...
setEPS()
cairo_ps("../latex/figures/fscore_blockdiag.ps", family = "Serif", height = 5, width = gr * 3.7)
...
setEPS()
cairo_ps("../latex/figures/recall_blockdiag.ps", family = "Serif", height = 5, width = gr * 3.7)
...
setEPS()
cairo_ps("../latex/figures/accuracy_blockdiag.ps", family = "Serif", height = 5, width = gr * 3.7)
...
setEPS()
cairo_ps("../latex/figures/spec_blockdiag.ps", family = "Serif", height = 5, width = gr * 3.7)
