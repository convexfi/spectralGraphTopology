...
k-component bipartite graphs, respectively: `learn_laplacian_matrix`, `learn_bipartite_graph`, and
`learn_adjacency_and_laplacian`.  In the next subsections, we will check out how to apply those functions
...
S <- cov(Y)
graph <- learn_laplacian_matrix(S, w0 = "qp", beta = 20, alpha = 5e-3,
