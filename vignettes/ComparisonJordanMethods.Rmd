...
#rmarkdown::render("vignettes/ComparisonJordanMethods.Rmd", "all")
#rmarkdown::render("vignettes/ComparisonJordanMethods.Rmd", "bookdown::html_document2")
#rmarkdown::render("vignettes/ComparisonJordanMethods.Rmd", "bookdown::pdf_document2")
#tools::compactPDF("vignettes/ComparisonJordanMethods.pdf", gs_quality = "ebook")
```
...
prial <- c(proposed = prial(Lw, res$Lw),
