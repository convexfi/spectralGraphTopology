...
gr = .5 * (1 + sqrt(5))
setEPS()
postscript("relative_error_block_diagonal_sss.ps", family = "ComputerModern", height = 5, width = gr * 3.5)
...
dev.off()
embed_fonts("relative_error_block_diagonal_sss.ps", outfile="relative_error_block_diagonal_sss.ps")
setEPS()
postscript("fscore_block_diagonal_sss.ps", family = "ComputerModern", height = 5, width = gr * 3.5)
...
legend("bottomright", legend = c("ISCM", "LLQP", "SGL"),
       col=c(colors[3], colors[4], colors[2]), pch=c(15, 17, 18), lty=c(1, 1, 1), bty="n")
dev.off()
embed_fonts("fscore_block_diagonal_sss.ps", outfile="fscore_block_diagonal_sss.ps")
